...
function assignCoordinates(tree, svg) { 
  ...
  for (var i = 0; i < tree.length; i++) {
    ...
    //     if (i != j) { 
    //       if (tree[i].x_coor == tree[j].x_coor && tree[i].y_coor == tree[j].y_coor && tree[i].x_coor) { 
    //         if (tree[i].nodeID < tree[j].nodeID) { 
    //           tree[i].x_coor -= 19.5
    //           tree[j].x_coor += 10.5
    //         }
    //       }
    //       if ((tree[i].x_coor - tree[j].x_coor) > 0 && (tree[i].x_coor - tree[j].x_coor) < 20 && tree[i].y_coor == tree[j].y_coor && tree[i].x_coor) { 
    //         if (tree[i].nodeID < tree[j].nodeID) { 
    //           tree[i].x_coor -= 22.5
    //           tree[j].x_coor += 15.5
    //         }
